...
<label class="layui-form-label">验证码</label>
                ...
                <div class="layui-form-item">
                    ...
                    <i  onclick="layer.msg('正在通过QQ登入', {icon: 10, time:0})" class="layui-icon layui-icon-login-qq" title="QQ登录"></i>
                    <i onclick="layer.msg('正在通过微信登入', {icon: 10, time:0})" class="layui-icon layui-icon-login-wechat" title="微信登录"></i>
                </div>
